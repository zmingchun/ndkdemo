...
extern "C" {//需要用  extern "C" { } 包住 c++ 函数体的定义和里面的变量，函数声明可以在外面。
jstring
Java_com_mmy_ndkdemo_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
    std::string hello = "来自C++世界的问候：你好！";
    return env->NewStringUTF(hello.c_str());
}


JNIEXPORT void JNICALL
Java_com_mmy_ndkdemo_IBMPhotoPhunActivity_convertToGray(
...
JNIEXPORT void JNICALL
Java_com_mmy_ndkdemo_IBMPhotoPhunActivity_changeBrightness(
        JNIEnv *env, jobject instance,
        jint direction, jobject bitmap) {
...
JNIEXPORT void JNICALL
Java_com_mmy_ndkdemo_IBMPhotoPhunActivity_findEdges(
        JNIEnv *env, jobject instance,
        jobject bitmapgray, jobject bitmapedges) {
